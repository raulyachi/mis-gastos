...
import { PlusCircle, List, LayoutDashboard, Trash2, Wallet, Tag, ArrowDownCircle, ArrowUpCircle, Calendar, Settings, Pencil, Download, LogOut } from 'lucide-react';
    ...
    return (
      <div className="flex justify-center bg-gray-100 min-h-screen font-sans">
        <div className="w-full max-w-md bg-white min-h-screen flex flex-col items-center justify-center p-6 shadow-2xl">
          ...
          <button 
            onClick={handleLogin}
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 font-bold py-4 px-6 rounded-xl hover:bg-gray-50 transition-colors shadow-sm active:scale-95"
          >
          ...
          {activeTab === 'add' && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
              ...
              <form onSubmit={handleAddTransaction} className="space-y-4">
                ...
                <button type="submit" disabled={!amount || !category} className={`w-full text-white font-bold py-4 rounded-xl shadow-lg mt-4 disabled:opacity-50 transition-all active:scale-95 ${txType === 'gasto' ? 'bg-red-500 shadow-red-200' : 'bg-emerald-600 shadow-emerald-200'}`}>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
              ...
              <form onSubmit={handleAddCategory} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button type="submit" disabled={!newCatName.trim()} className="bg-gray-800 text-white px-4 py-2 rounded-lg text-sm font-semibold disabled:opacity-50">Añadir</button>
                </div>
              </form>
